...
public class Accessories extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile.setOnClickListener(v -> {
            ...
            intent = new Intent(Accessories.this, Profile.class);
        ...
        cart.setOnClickListener(v -> {
            //Starts Profile Screen and closes this screen
            intent = new Intent(Accessories.this, Cart.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        intent = new Intent(Accessories.this, Index.class);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch(position) {
            ...
            case 1:
                ...
                break;
            case 2:
                intent = new Intent(Accessories.this, Apparel.class);

                startActivity(intent);
                finish();
                break;
            case 3:
                intent = new Intent(Accessories.this, Accessories.class);

                startActivity(intent);
                finish();
                break;
            case 4:
                intent = new Intent(Accessories.this, Figurines.class);

                startActivity(intent);
                finish();
                break;
            case 5:
                intent = new Intent(Accessories.this, Posters.class);

                startActivity(intent);
                finish();
                break;
            case 6:
                intent = new Intent(Accessories.this, MainActivity.class);
    ...
    private void initialiseVars() {
        ...
        menuDropDown = ArrayAdapter.createFromResource(Accessories.this, R.array.dropDown2, android.R.layout.simple_spinner_item);
        //Sets Drop Down - Drop Down Layout
        menuDropDown.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        menu.setPopupBackgroundResource(R.color.accessories);
        menu.setAdapter(menuDropDown);
        menu.setOnItemSelectedListener(this);

        //Setting up the Adapter - Context, string-array, layout
        sortDropDown = ArrayAdapter.createFromResource(Accessories.this, R.array.sort, android.R.layout.simple_spinner_item);
        //Sets Drop Down - Drop Down Layout
        sortDropDown.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        sort.setPopupBackgroundResource(R.color.accessories);
        sort.setAdapter(sortDropDown);
        sort.setOnItemSelectedListener(null);
    }

    private void goToPurchase() {
        intent = new Intent(Accessories.this, Purchase.class);
