...
public class NewArrivals extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile.setOnClickListener(v -> {
            ...
            intent = new Intent(NewArrivals.this, Profile.class);
        ...
        cart.setOnClickListener(v -> {
            //Starts Profile Screen and closes this screen
            intent = new Intent(NewArrivals.this, Cart.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        intent = new Intent(NewArrivals.this, Index.class);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch(position) {
            ...
            case 1:
                ...
                break;
            case 2:
                intent = new Intent(NewArrivals.this, Apparel.class);

                startActivity(intent);
                finish();
                break;
            case 3:
                intent = new Intent(NewArrivals.this, Accessories.class);

                startActivity(intent);
                finish();
                break;
            case 4:
                intent = new Intent(NewArrivals.this, Figurines.class);

                startActivity(intent);
                finish();
                break;
            case 5:
                intent = new Intent(NewArrivals.this, Posters.class);

                startActivity(intent);
                finish();
                break;
            case 6:
                intent = new Intent(NewArrivals.this, MainActivity.class);
    ...
    private void initialiseVars() {
        ...
        menuDropDown = ArrayAdapter.createFromResource(NewArrivals.this, R.array.dropDown2, android.R.layout.simple_spinner_item);
        //Sets Drop Down - Drop Down Layout
        menuDropDown.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        menu.setPopupBackgroundResource(R.color.newArrivals);
        menu.setAdapter(menuDropDown);
        menu.setOnItemSelectedListener(this);

        //Setting up the Adapter - Context, string-array, layout
        sortDropDown = ArrayAdapter.createFromResource(NewArrivals.this, R.array.sort, android.R.layout.simple_spinner_item);
        //Sets Drop Down - Drop Down Layout
        sortDropDown.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        sort.setPopupBackgroundResource(R.color.newArrivals);
        sort.setAdapter(sortDropDown);
        sort.setOnItemSelectedListener(null);
    }

    private void goToPurchase() {
        intent = new Intent(NewArrivals.this, Purchase.class);

        PurchaseInfo.setImage(R.drawable.new_arrivals_banner_item);
