...
public class BestSellers extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                profile.setOnClickListener(v -> {
                        ...
                        intent = new Intent(BestSellers.this, Profile.class);
                ...
                cart.setOnClickListener(v -> {
                        //Starts Profile Screen and closes this screen
                        intent = new Intent(BestSellers.this, Cart.class);
        ...
        public void onBackPressed() {
                super.onBackPressed();
                intent = new Intent(BestSellers.this, Index.class);
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                        ...
                        case 1:
                                ...
                                break;
                        case 2:
                                intent = new Intent(BestSellers.this, Apparel.class);

                                startActivity(intent);
                                finish();
                                break;
                        case 3:
                                intent = new Intent(BestSellers.this, Accessories.class);

                                startActivity(intent);
                                finish();
                                break;
                        case 4:
                                intent = new Intent(BestSellers.this, Figurines.class);

                                startActivity(intent);
                                finish();
                                break;
                        case 5:
                                intent = new Intent(BestSellers.this, Posters.class);

                                startActivity(intent);
                                finish();
                                break;
                        case 6:
                                intent = new Intent(BestSellers.this, MainActivity.class);
        ...
        private void initialiseVars() {
                ...
                menuDropDown = ArrayAdapter.createFromResource(BestSellers.this, R.array.dropDown2, android.R.layout.simple_spinner_item);
                //Sets Drop Down - Drop Down Layout
                menuDropDown.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                menu.setPopupBackgroundResource(R.color.bestSellers);
                menu.setAdapter(menuDropDown);
                menu.setOnItemSelectedListener(this);

                //Setting up the Adapter - Context, string-array, layout
                sortDropDown = ArrayAdapter.createFromResource(BestSellers.this, R.array.sort, android.R.layout.simple_spinner_item);
                //Sets Drop Down - Drop Down Layout
                sortDropDown.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                sort.setPopupBackgroundResource(R.color.bestSellers);
                sort.setAdapter(sortDropDown);
                sort.setOnItemSelectedListener(null);
        }

        private void goToPurchase() {
                intent = new Intent(BestSellers.this, Purchase.class);

                PurchaseInfo.setImage(R.drawable.best_seller_banner_item);
